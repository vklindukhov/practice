...
//        new samples.practice.QuizfulCertifiedJavaProgrammer().new IC();
//        samples.practice.QuizfulCertifiedJavaProgrammer oC = new samples.practice.QuizfulCertifiedJavaProgrammer().new CIC();
//
//        oC.new CIC();
//        oC.new CIC().new CIC();
    }
...
//}
//
//class CIC extends samples.practice.QuizfulCertifiedJavaProgrammer {
//}
...
//    public void run() {
//        synchronized ((samples.practice.QuizfulCertifiedJavaProgrammer.class)) {
//            try {
//                samples.practice.QuizfulCertifiedJavaProgrammer.class.wait();
//            } catch (InterruptedException e) {
...
//        set();
//        synchronized (samples.practice.QuizfulCertifiedJavaProgrammer.class) {
//            samples.practice.QuizfulCertifiedJavaProgrammer.class.notifyAll();
//        }
//    }
//}